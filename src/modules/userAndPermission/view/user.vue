  ...
  methods: {
    getAllUser () {
      ...
      this.$store.dispatch('getAllUser', {
        ...
        filterTitle: this.filter.title,
        filterStatus: this.filter.status,
    ...
    changeContent () {
      this.loadTable = true
      this.$store.dispatch('getAllUser', { pageNumber: this.currentPage, filterTitle: this.filter.title, filterStatus: this.filter.status, filterRole: this.filter.role }).then(() => {
        this.loadTable = false
      })
    },
    selectAll () {
