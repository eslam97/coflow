...
export default {
  ...
  getLeadReport (filter, pageNumber, search, project, userId, callStatusId, inquiry, source, from, dateFrom, dateTo, ifNew, category, noHistory, userid, takenId, type) {
    if (filter) {
      if (noHistory) {
        return Api().get(`leads/reports/details?page=${pageNumber}&search=${search}&project_id=${project}&user=${userId}&call_status_id=${callStatusId}&inquiry_id=${inquiry}&source_id=${source}&from_id=${from}&date_from=${dateFrom}&date_to=${dateTo}&new=${ifNew}&category=${category}&no_history=1&user_id=${userid}&taken_id=${takenId}&filter=${filter}&type=${type}`)
      } else { return Api().get(`leads/reports/details?page=${pageNumber}&search=${search}&project_id=${project}&user=${userId}&call_status_id=${callStatusId}&inquiry_id=${inquiry}&source_id=${source}&from_id=${from}&date_from=${dateFrom}&date_to=${dateTo}&new=${ifNew}&category=${category}&user_id=${userid}&taken_id=${takenId}&filter=${filter}&type=${type}`) }
    } else {
      if (noHistory) {
        return Api().get(`leads/reports/details?page=${pageNumber}&search=${search}&project_id=${project}&user=${userId}&call_status_id=${callStatusId}&inquiry_id=${inquiry}&source_id=${source}&from_id=${from}&date_from=${dateFrom}&date_to=${dateTo}&new=${ifNew}&category=${category}&no_history=1&user_id=${userid}&taken_id=${takenId}&type=${type}`)
      } else { return Api().get(`leads/reports/details?page=${pageNumber}&search=${search}&project_id=${project}&user=${userId}&call_status_id=${callStatusId}&inquiry_id=${inquiry}&source_id=${source}&from_id=${from}&date_from=${dateFrom}&date_to=${dateTo}&new=${ifNew}&category=${category}&user_id=${userid}&taken_id=${takenId}&type=${type}`) }
    }
  },
  ...
  getContractsSalesReport (pageNumber, projectId, dateFrom, dateTo, userId) {
    return Api().get(`sales/reports/contracts?page=${pageNumber}&project_id=${projectId}&date_from=${dateFrom}&date_to=${dateTo}&sales_id=${userId}`)
  },
